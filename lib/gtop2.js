...
var cpuLine = grid.set(0, 0, 4, 10, contrib.line, {
  showNthLabel: 5,
  maxY: 100,
  label: 'CPU History',
  showLegend: false,
...
var cpuLegend = grid.set(0, 10, 12, 2, contrib.table, {
  keys: true,
  interactive: false,
  label: '%CPU',
  columnSpacing: 1,
...
var memLine = grid.set(4, 0, 4, 7, contrib.line, {
  showNthLabel: 5,
  maxY: 100,
...
var memDonut = grid.set(4, 7, 2, 3, contrib.donut, {
  radius: 8,
  arcWidth: 3,
  yPadding: 2,
  remainColor: 'black',
...
var swapDonut = grid.set(6, 7, 2, 3, contrib.donut, {
  radius: 8,
  arcWidth: 3,
  yPadding: 2,
  remainColor: 'black',
...
var netSpark = grid.set(8, 0, 2, 4, contrib.sparkline, {
...
var diskDonut = grid.set(10, 0, 2, 4, contrib.donut, {
  radius: 8,
  arcWidth: 3,
  yPadding: 2,
  remainColor: 'black',
...
var procTable = grid.set(8, 4, 4, 6, contrib.table, {
  keys: true,
  label: 'Processes',
  columnSpacing: 1,
...
function init() {
  ...
  new monitor.Cpul(cpuLegend); //no Windows support
